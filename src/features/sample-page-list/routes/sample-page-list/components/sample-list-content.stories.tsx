...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "すべてのサンプルページをカテゴリ別に表示します。フォーム、認証、ユーザー管理などのカテゴリに分類されています。",
      },
    },
  },
};
...
export const SingleCategory: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "特定のカテゴリ（ユーザー管理）のサンプルのみを表示します。フィルタリング機能の実装例として活用できます。",
      },
    },
  },
};
...
export const CustomSamples: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "カスタムデータを使用した表示例。独自のサンプルページ一覧を作成する際の参考になります。",
      },
    },
  },
};
...
export const Empty: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "サンプルが1つもない場合の表示。空の状態のハンドリングを確認できます。",
      },
    },
  },
};
