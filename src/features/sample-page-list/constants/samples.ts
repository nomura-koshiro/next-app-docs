...
export const SAMPLES: SampleItem[] = [
  ...
  },
  {
    title: "ユーザー新規作成",
    description:
      "新規データ作成フォームのサンプル。バリデーション、送信処理、エラーハンドリング、成功時のリダイレクトなどの実装例です。",
  ...
  },
  {
    title: "ユーザー編集",
    description:
      "既存データの編集フォームのサンプル。データの取得、フォームへの初期値設定、更新処理、楽観的更新の実装例です。",
  ...
  },
  {
    title: "ユーザー削除",
    description:
      "データ削除機能のサンプル。削除確認ダイアログ、削除処理、エラーハンドリング、成功時のリダイレクトなどの実装例です。",
